...
export const events: Event[] = [
  {
    slug: "future-tech-leadership-summit-2026",
    title: "Future Tech Leadership Summit 2026",
    shortDescription:
      "A comprehensive summit for emerging and established tech leaders to explore the future of technology leadership.",
    description: `Join us for an inspiring full-day summit designed for current and aspiring technology leaders.

This event brings together industry experts, successful leaders, and rising stars to explore:
- Leadership strategies for the digital age
- Building inclusive and diverse tech teams
- Navigating career transitions into leadership roles
- Managing remote and hybrid teams effectively
- Innovation and strategic thinking in tech
- Work-life balance for leaders

Whether you're a team lead, engineering manager, or aspiring to leadership, this summit provides valuable insights, practical tools, and networking opportunities to accelerate your leadership journey.`,
    category: "conference",
    status: "upcoming",
    isFeatured: false,
    ...
    speakers: [
      {
        ...
        bio: "Jennifer has led engineering teams at multiple Fortune 500 companies and is passionate about developing the next generation of tech leaders.",
      ...
      },
      {
        ...
        bio: "Dr. Patel is a recognized thought leader in technology strategy and has been instrumental in scaling multiple tech startups.",
        image: "https://api.dicebear.com/7.x/avataaars/svg?seed=aisha",
      },
      {
        name: "Rachel Thompson",
        title: "Director of Engineering",
        company: "Cloud Systems NZ",
        bio: "Rachel specializes in building high-performing engineering teams and has over 15 years of leadership experience.",
        image: "https://api.dicebear.com/7.x/avataaars/svg?seed=rachelt",
      },
    ],
    agenda: [
      ...
      {
        time: "09:30",
        title: "Opening Keynote: The Future of Tech Leadership",
      ...
      {
        time: "11:00",
        title: "Workshop: Building Inclusive Teams",
        description: "Practical strategies for creating diverse and inclusive technology teams.",
        type: "workshop",
      },
      {
        time: "12:30",
      ...
      {
        time: "13:30",
        title: "Panel: Navigating Leadership Transitions",
        description: "Experienced leaders share their journeys and advice for transitioning into leadership roles.",
        type: "panel",
      },
      {
        time: "14:45",
      ...
      {
        time: "15:15",
        title: "Workshop: Strategic Thinking for Tech Leaders",
        description: "Learn how to think strategically and make impactful decisions.",
        type: "workshop",
      },
      {
        time: "16:15",
        title: "Closing Keynote: Leading with Purpose",
    ...
    registration: {
      ...
      deadline: "2026-02-10",
      externalUrl: "https://example.com/register/future-tech-leadership-summit-2026",
    },
    coverImage:
