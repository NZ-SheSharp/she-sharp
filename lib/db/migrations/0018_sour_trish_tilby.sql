CREATE TYPE "public"."volunteer_current_status" AS ENUM('high_school_student', 'university_student', 'industry', 'sponsor_partner', 'other');--> statement-breakpoint
CREATE TYPE "public"."volunteer_type" AS ENUM('ambassador', 'volunteer');--> statement-breakpoint
...
CREATE INDEX "volunteer_form_status_idx" ON "volunteer_form_submissions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "volunteer_form_email_idx" ON "volunteer_form_submissions" USING btree ("email");--> statement-breakpoint
CREATE INDEX "volunteer_form_type_idx" ON "volunteer_form_submissions" USING btree ("type");