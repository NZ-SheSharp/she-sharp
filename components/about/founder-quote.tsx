...
export function FounderQuote() {
  return (
    <Section noPadding className="relative overflow-hidden bg-periwinkle py-16 md:py-24 lg:py-32">
      {/* Decorative circles */}
      <div className="absolute top-12 right-[15%] w-24 h-24 md:w-32 md:h-32 rounded-full bg-[#F5D5D5]/20" />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 text-white order-2 lg:order-1">
              ...
              <blockquote className="text-base md:text-lg lg:text-xl  mb-8 space-y-4">
                <p>
                  <span className="text-white">"</span>As the Director of She Sharp, I am proud to lead an organization dedicated to empowering women in tech. Despite women making up over half of the population, they represent only 20% of roles in STEM fields.
                </p>
                <p>
            ...
            <div className="relative order-1 lg:order-2 shrink-0">
              ...
              {/* Photo container */}
              <div className="relative w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full overflow-hidden border-4 border-white/20">
                <Image
