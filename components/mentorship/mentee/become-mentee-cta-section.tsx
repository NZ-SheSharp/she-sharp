            ...
            <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center text-white">
              ...
              <div className="flex flex-col items-center md:items-center gap-6">
                <Button
                  asChild
                  size="lg"
                  className="bg-white text-purple-dark hover:bg-white/90 text-lg font-bold px-10 py-7 h-auto shadow-lg shadow-black/20 group transition-all duration-300 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.03]"
                >
