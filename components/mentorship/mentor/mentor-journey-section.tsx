    ...
    <Section className="py-16 lg:py-24 bg-white">
      <Container>
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-linear-to-b from-purple-light to-periwinkle-light" />
                    ...
                    <div className="space-y-2">
                      {step.checklist.map((item) => (
                        <div key={item} className="flex items-center gap-2 text-sm">
                          <CheckCircle2 className="h-4 w-4 text-mint-dark shrink-0" />
