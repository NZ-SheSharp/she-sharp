...
export function BecomeMentorCTASection() {
  ...
  return (
    <Section className="py-16 bg-linear-to-br from-periwinkle-light via-periwinkle-mid to-periwinkle-dark relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-12">
              ...
              <div className="w-full md:w-1/2 flex flex-col gap-4">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="border-white text-white hover:bg-white/10 w-fit mt-8 bg-periwinkle-dark"
                >
                  <a
