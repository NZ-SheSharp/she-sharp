...
export function MentorsHeroSection() {
  ...
  return (
    <Section className="relative overflow-hidden bg-navy-dark">
      <div className="absolute inset-0 bg-linear-to-br from-navy-dark via-purple-dark/20 to-periwinkle-dark/30" />
                ...
                <CarouselContent>
                  {featuredMentors.map((mentor) => (
                    <CarouselItem key={mentor.id} className="md:basis-1/2 lg:basis-full">
                      <div className="p-1">
                        <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-linear-to-br from-purple-dark to-periwinkle-dark p-1">
