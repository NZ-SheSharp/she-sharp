...
export const presetQuestions: PresetQuestion[] = [
  ...
  {
    id: '6',
    question: 'What programs does She Sharp offer?',
    answer:
      'She Sharp offers several key programs:\n1. **Mentorship Program** - 1-on-1 mentoring connections\n2. **THRIVE** - Leadership development program\n3. **Networking Events** - Regular meetups and workshops\n4. **Career Resources** - Learning materials and job opportunities\n5. **Community Forums** - Online networking\n\nAll programs support women at every stage of their STEM journey.\n\n**Explore:** [Mentorship Program](/mentorship) | [Events](/events) | [About Us](/about)',
    category: 'general',
  },
  {
    id: '7',
  ...
  // EVENTS (group 4)
  {
    ...
    answer:
      "She Sharp hosts regular events including networking meetups, technical workshops, and special programs like THRIVE. We typically host events monthly, both virtual and in-person, covering topics from technical skills to career development.\n\n**Explore events:** [Upcoming Events](/events) | [Photo Gallery](/resources#gallery)",
    category: 'events',
  },
