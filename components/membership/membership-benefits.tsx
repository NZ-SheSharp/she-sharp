...
export function MembershipBenefits() {
  return (
    <Section spacing="section" className="py-16 md:py-24 lg:py-32 bg-white">
      <Container size="full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {membershipBenefits.map((benefit, index) => (
            <div
              key={index}
              className="group p-6 rounded-[32px] bg-[#f7e5f3]/30 hover:bg-[#f7e5f3]/60 transition-all duration-300"
            >
