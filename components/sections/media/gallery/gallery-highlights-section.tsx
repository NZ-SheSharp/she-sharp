  ...
  return (
    <Section bgColor="white">
      <Container size="wide">
        ...
        >
          <Badge className="mb-4 bg-periwinkle-light text-periwinkle-dark border-periwinkle-dark/20">
            Visual Stories
          </Badge>
        ...
        <div className={layoutClasses(
          ...
          {photoStats.map((stat, index) => (
            ...
            >
              <div className="inline-flex p-3 rounded-full bg-periwinkle-light/20 mb-3">
                <stat.icon className="h-6 w-6 text-periwinkle-dark" />
              </div>
            ...
            >
              ...
              >
                <div className="relative aspect-[16/9]">
                  ...
                  {/* Featured Badge */}
                  {category.featured && (
                    <Badge className="absolute top-4 right-4 bg-purple-dark text-white">
                      Featured
                    </Badge>
                  )}
                </div>
