      ...
      <div className="legal-content">
        ...
        <section className="legal-section">
          <div className="legal-info-box">
            ...
            <div className="flex items-center gap-3 p-4 bg-white/50 rounded-lg">
              <Heart className="h-5 w-5 text-purple-dark flex-shrink-0" />
              ...
              <div
                ...
                className={`text-center p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 ${
                  value.color === "purple"
                    ...
                    ? "bg-gradient-to-br from-periwinkle-light/20 to-periwinkle-dark/10"
                    : "bg-gradient-to-br from-mint-light/20 to-mint-dark/10"
                }`}
              >
        ...
        <section className="legal-section">
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="legal-highlight-box">
                <h3 className="!mt-0 flex items-center gap-3">
                  <CheckCircle className="h-6 w-6 text-periwinkle-dark" />
                  At Events & Online
                </h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
        ...
        <section className="legal-section">
          ...
          <div className="legal-warning-box">
            <div className="flex items-start gap-4">
              <Ban className="h-6 w-6 text-mint-dark mt-1" />
              <div className="flex-1">
                <h3 className="!mt-0 text-lg">The following behaviors are not tolerated:</h3>
                
                <div className="grid md:grid-cols-2 gap-6 mt-6">
                  <div>
                    <h4 className="font-semibold text-navy-dark mb-3">Harassment & Discrimination</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-navy-dark mb-3">Disruptive Behavior</h4>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="text-error">✗</span>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div key={item} className="flex items-center gap-3 p-3 bg-white/70 rounded-lg">
                  <Heart className="h-4 w-4 text-purple-dark flex-shrink-0" />
                  <span className="text-sm text-navy-dark">{item}</span>
                </div>
              ))}
            </div>
            
            <p className="mt-6 text-sm text-navy-dark">
        ...
        <section className="legal-section">
          ...
          <div className="space-y-6">
            <div className="legal-highlight-box">
              <h3 className="!mt-0 flex items-center gap-3">
                <Flag className="h-6 w-6 text-purple-dark" />
                How to Report
              </h3>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-4 bg-white/50 rounded-lg">
                  <h4 className="font-semibold text-navy-dark mb-2">At Events</h4>
                  <ul className="space-y-2 text-sm">
                ...
                <div className="p-4 bg-white/50 rounded-lg">
                  <h4 className="font-semibold text-navy-dark mb-2">Online</h4>
                  <ul className="space-y-2 text-sm">
            ...
            <div className="legal-warning-box">
              ...
              <div className="legal-numbered-list">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-navy-dark mb-2">Immediate Safety</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-navy-dark mb-2">Investigation</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-navy-dark mb-2">Action</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-navy-dark mb-2">Follow-up</h4>
        ...
        <section className="legal-section">
          ...
          <div className="bg-gradient-to-r from-purple-light/30 to-periwinkle-light/30 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-navy-dark mb-3">Immediate Actions</h4>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <AlertCircle className="h-4 w-4 text-purple-dark mt-0.5" />
              ...
              <div>
                <h4 className="font-semibold text-navy-dark mb-3">Long-term Actions</h4>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <AlertCircle className="h-4 w-4 text-periwinkle-dark mt-0.5" />
            ...
            <p className="text-sm text-navy-dark mt-4 mb-0">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <div key={scope.title} className="p-4 bg-periwinkle-light/20 rounded-lg border border-periwinkle-dark/20">
                  <scope.icon className="h-6 w-6 text-periwinkle-dark mb-2" />
                  <h4 className="font-semibold text-navy-dark">{scope.title}</h4>
                  <p className="text-sm text-gray">{scope.desc}</p>
                </div>
              ))}
            </div>
            
            <p className="text-sm text-navy-dark mt-4">
          ...
          <div className="legal-contact-card">
            <div className="text-center">
              ...
              <div className="grid sm:grid-cols-2 gap-6 max-w-lg mx-auto">
                <div>
                  <h4 className="font-semibold text-navy-dark mb-2">Report Issues</h4>
                  <a href="mailto:conduct@shesharp.org.nz" className="text-purple-dark hover:text-purple-mid">
                    conduct@shesharp.org.nz
                  </a>
                </div>
                
                <div>
                  <h4 className="font-semibold text-navy-dark mb-2">General Inquiries</h4>
                  <a href="mailto:hello@shesharp.org.nz" className="text-purple-dark hover:text-purple-mid">
