      ...
      <div className="legal-content">
        ...
        <section className="legal-section">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div className="bg-muted rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
        ...
        <section className="legal-section">
          ...
          <div className="legal-warning-box">
            <div className="flex items-start gap-4">
              <Bug className="h-6 w-6 text-foreground mt-1" />
              <div className="flex-1">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-foreground mb-3">How to Report</h4>
          ...
          <div className="bg-muted rounded-xl p-6">
            ...
            <div className="legal-numbered-list">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Immediate Containment</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Assessment & Investigation</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Remediation</h4>
        ...
        <section className="legal-section">
          ...
          <div className="legal-contact-card">
            <div className="flex items-start gap-4">
              <Mail className="h-8 w-8 text-foreground mt-1" />
              <div className="flex-1">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-foreground mb-2">Security Team</h4>
                    <a href="mailto:security@shesharp.org.nz" className="text-foreground hover:text-foreground/80 transition-colors">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@shesharp.org.nz" className="text-foreground hover:text-foreground/80 transition-colors">
